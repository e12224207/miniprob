...
let loadedMiniProbGrammar: Grammar | undefined;
export const MiniProbGrammar = (): Grammar => loadedMiniProbGrammar ?? (loadedMiniProbGrammar = loadGrammarFromJson(`{
  "$type": "Grammar",
  "isDeclared": true,
  "name": "MiniProb",
  "rules": [
